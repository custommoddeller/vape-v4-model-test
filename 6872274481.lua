			...
			if callback then
				...
				task.spawn(function()
					...
					supriseconnc = lplr.characterAdded:Connect(function()
						...
						task.wait(1)
						tweenService:Create(entityLibrary.character.HumanoidRootPart, TweenInfo.new(1, Enum.EasingStyle.Sine), {CFrame = CFrame.new(selectedPlayer.Character.HumanoidRootPart.Position + Vector3.new(0, 10, 0))}):Play()
					end)
				end)
